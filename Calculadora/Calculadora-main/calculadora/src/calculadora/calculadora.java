...
public class calculadora extends JFrame {
	...
	public calculadora() {
		...
		display.setText("");
		display.setBounds(20, 11, 293, 60);
		...
		btn_porcentagem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String numero1Porcentagem=display.getText();
				double numero1=Double.parseDouble(numero1Porcentagem);
		...
		btn_divisao.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String numero1Divisao=display.getText();
				double numero1=Double.parseDouble(numero1Divisao);
				numeroUsar.setNumero1(numero1);
				numeroUsar.setOperacao("/");
				display.setText("");
		}});
		...
		btn_multiplicacao.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String numero1Multiplicacao=display.getText();
				double numero1=Double.parseDouble(numero1Multiplicacao);
				numeroUsar.setNumero1(numero1);
				numeroUsar.setOperacao("x");
				display.setText("");
		}});
		...
		btn_subtracao.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String numero1Subtracao=display.getText();
				double numero1=Double.parseDouble(numero1Subtracao);
				numeroUsar.setNumero1(numero1);
				numeroUsar.setOperacao("-");
				display.setText("");
			}
