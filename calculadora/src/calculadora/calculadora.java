...
public class calculadora extends JFrame {
	...
	public calculadora() {
		...
		btn_7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String btn7="7";
				numeroUsar. numeroDigitado(btn7);
				
				double numeroDisplay=numeroUsar.getNumero();
				String numeroApareceDisplay= Double.toString(numeroDisplay);
				
				display.setText(numeroApareceDisplay);
			}
		});
		...
		btn_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String btn8="8";
				numeroUsar.numeroDigitado(btn8);
		...
		btn_9.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String btn9="9";
				numeroUsar.numeroDigitado(btn9);
		...
		btn_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String btn4="4";
				numeroUsar. numeroDigitado(btn4);
		...
		btn_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String btn5="5";
				numeroUsar. numeroDigitado(btn5);
		...
		btn_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String btn6="6";
				numeroUsar. numeroDigitado(btn6);
		...
		btn_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			String btn1="1";
				numeroUsar. numeroDigitado(btn1);
		...
		btn_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String btn2="2";
				numeroUsar. numeroDigitado(btn2);
		...
		btn_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String btn3="3";
				numeroUsar. numeroDigitado(btn3);
		...
		btn_0.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String btn0="0";
				numeroUsar. numeroDigitado(btn0);
